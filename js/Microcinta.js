...
document.getElementById("btn_impedancia_microcinta").onclick=function(){
 ...
 function Calculo_dimensiones_microcinta(){
    ...
    var perm=document.getElementById("dielectrico1");
    ...
    if(perm.value==0 && (document.getElementById("dielectrico_in1").value==null || document.getElementById("dielectrico_in1").value=="" )){
    ...
    if(perm.value!=0){
       ...
       permitividad_relativa=Number(document.getElementById("dielectrico_in1").value);
    ...
    W=WH*H;
     ...
     if(WH<0 ){
        ...
        swal("Datos erroneos!", "Ancho de la linea da como resultado un numero menor a 0", "warning");
